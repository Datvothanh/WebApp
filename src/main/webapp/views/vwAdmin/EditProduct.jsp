...
<jsp:useBean id="product" scope="request" type="com.ute.webapp.beans.Product"/>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="intProID">#</label>
                        <input type="number" class="form-control" id="intProID" name="ProID" readonly value="${product.proID}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="intPrice" name="Price" value="${product.price}">
                    </div>
                    <div class="form-group">
                        <label for="txtColor">Color</label>
                        <input type="text" class="form-control" id="txtColor" name="Color" value="${product.color}">
                    </div>
                    <div class="form-group">
                        <label for="intType">Type</label>
                        <input type="number" class="form-control" id="intType" name="Type" value="${product.type}">
                    </div>
                    <div class="form-group">
                        <label for="txtTrademark">Trademark</label>
                        <input type="text" class="form-control" id="txtTrademark" name="Trademark" value="${product.trademark}">
                    </div>
                    <div class="form-group">
                        <label for="intQuantity">Quantity</label>
                        <input type="number" class="form-control" id="intQuantity" name="Quantity" value="${product.quantity}">
                    </div>
                    <div class="form-group">
